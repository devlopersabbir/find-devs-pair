export default function BackgroundBlurry() {
  return (
    <div className="absolute inset-0">
      ...
      <div className="absolute top-1/3 right-1/3 w-48 h-48 bg-gradient-to-r from-yellow-500/20 via-orange-500/20 to-red-500/20 rounded-full blur-3xl animate-pulse delay-3000"></div>
    </div>
  );
}
